...
def main():
    ...
    maskClassifier = Classifier('E:\VisualStudioCode_project\Python_project\Machine\Image_Identification2\keras_model.h5', 'E:\VisualStudioCode_project\Python_project\Machine\Image_Identification2\labels.txt')
    while True:
        _, img = cap.read()
